						...
						<div class="footer-widget contact-widget">
							...
							<form class="fw-contact-form" method="post" action="?module=update_password">
								...
								<div class="cf-inputs">
									...
									<div class="cf-input">
										<input type="password" name="password" class="cf-input" id="txtPassword" placeholder="Password Baru" required>
									</div>
									<div class="cf-input">
										<input type="password" name="password" class="cf-input" id="txtConfirmPassword" placeholder="Konfirmasi Password" required>
									</div>
								</div>
								<button type="submit" name="submit" onclick="return Validate();" class="site-btn">Simpan Perubahan</button>
							</form>
						</div>
					</div>
				</div>
