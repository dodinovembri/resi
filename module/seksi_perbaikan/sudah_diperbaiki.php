				...
				<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
		            ...
		            <?php foreach ($nama_kriteria as $key) {
		              echo '<th>'.$key.'</th>';
		                ...
		                <?php  
		            include 'module/koneksi.php';
		            $query_kriteria = mysqli_query($koneksi, "SELECT * FROM alternatif WHERE status='S'");
		            $no = 0;
		            ...
		            ?>
		                  <tr class='success'>
		                    ...
		                    <!-- <td class='action'> -->
		                      ...
		                      <!-- <a class='btn btn-info' href='?module=edit&id_alternatif=<?php echo $id_alternatif; ?>'>                 
